...
export class TicketService {
   ...
   * Ticket
   */
  async createTicket(input: CreateTicketInput): Promise<ParkingTicket> {
    /**
     * Find available slot.
     *
     ...
     * use that slot.
     */
    const slot = await this.parkingService.occupySlot(input.slotId);
   ...
   * Amount
   */
  async closeTicket(input: CloseTicketInput): Promise<ParkingTicket> {
     ...
     * Calculate amount.
     */
    const amount = await this.pricingService.calculateAmount(
